  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        tenthImage: "url('/Licht eiken trap met verlichting.jpeg')",
        eleventhImage:
          "url('/Zand eiken trap met witte stootborden verlicht.jpeg')",
        twelfthImage: "url('/Zand eiken treden trap met verlichting.jpeg')",
      },
      brightness: {
        25: ".25",
        175: "1.75",
