    ...
    <>
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mt-16 mb-32">
          <div className="bg-firstImage 2xl:w-[450px] 2xl:h-[640px] xl:w-[409px] xl:h-[568px] lg:w-[325px] lg:h-[455px] w-[245px] h-[455px] bg-cover bg-mbotto rounded-xl" />
          ...
          <div className="bg-secondImage 2xl:w-[450px] 2xl:h-[640px] xl:w-[409px] xl:h-[568px] lg:w-[325px] lg:h-[455px] md:w-[245px] md:h-[455px] w-[285px] h-[455px] bg-cover bg-bottom" />
          <div className="bg-firstImage 2xl:w-[450px] 2xl:h-[640px] xl:w-[409px] xl:h-[568px] lg:w-[325px] lg:h-[455px] md:w-[245px] md:h-[455px] w-[285px] h-[455px] bg-cover bg-bottom" />
          <div className="bg-secondImage 2xl:w-[450px] 2xl:h-[640px] xl:w-[409px] xl:h-[568px] lg:w-[325px] lg:h-[455px] md:w-[245px] md:h-[455px] w-[285px] h-[455px] bg-cover bg-bottom" />
          <div className="bg-secondImage 2xl:w-[450px] 2xl:h-[640px] xl:w-[409px] xl:h-[568px] lg:w-[325px] lg:h-[455px] md:w-[245px] md:h-[455px] w-[285px] h-[455px] bg-cover bg-bottom" />
        </div>
